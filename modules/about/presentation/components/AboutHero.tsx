...
// ─────────────────────────────────────────────
// Ilustración lateral — tarjeta de perfil de la
// empresa: filas ícono + dato con fade-in
// escalonado, y chips flotantes de refuerzo
// ─────────────────────────────────────────────
function AboutIllustration() {
  const rows = [
    { label: "Fundada en 2015", icon: "calendar" },
    { label: "Morelia, México", icon: "pin" },
    { label: "Soporte directo", icon: "headset" },
    { label: "Confianza y resultados", icon: "check" },
  ];

  const chips = [
    { label: "+100 equipos atendidos", pos: "top-0 -left-2 sm:-left-12" },
    { label: "100% atención personalizada", pos: "bottom-6 -right-2 sm:-right-12" },
  ];
        ...
        <div className="flex items-center gap-3 border-b border-white/10 bg-white/5 px-5 py-4">
          ...
          <div>
            <p className="text-sm font-semibold text-white/90">
              Sit+ · Perfil de la empresa
            </p>
            <p className="text-xs text-white/40">Tecnología con propósito</p>
          </div>
        </div>
