...
import { campaignStatus } from "@/core/mocked-data/promotions-current";
import { useTranslations } from "next-intl";

export default function PromotionsCTA() {
  const t = useTranslations("promotions");

  const suffix = campaignStatus === "upcoming" ? "Upcoming" : "Active";
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center pt-2">
          ...
          <div className="w-full sm:w-auto flex">
            <HomeCTAButton href="/store" variant="outline">
              {t("ctaSecondaryBtn")}
            </HomeCTAButton>
          </div>
        </div>
