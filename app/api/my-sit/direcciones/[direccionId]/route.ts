...
type Params = { params: Promise<{ direccionId: string }> };

// PATCH — actualiza una dirección del cliente autenticado
...
// DELETE — elimina una dirección del cliente autenticado
